            ...
            <div class="card">
                <div class="card-header">
                    <span class="d-flex align-items-center auth-card-header">
                        ...
                        <h6 style="margin-top: 5px;"><strong>New Consultation</strong></h6>
                    </span>
                </div>
                <div class="card-body">
              
                    <form action="{{ route('checkup-forms.daily.register') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-row row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="ht_wt" id="ht_wt" class="form-control" >
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="form-row row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="service_provided" id="service_provided" class="form-control" >
                            </div>
                            <div class="col-lg-4">
                                <label for="med_given">Medicine given:</label>
                                <input type="text" name="med_given" id="med_given" class="form-control" >
                            </div>
                        </div>
                        <div class="form-row row">
